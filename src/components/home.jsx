  ...
  return (
    <div className="h-screen flex flex-col justify-center items-center bg-[#192734] p-4">
      ...
      <div className="flex flex-col space-y-10 justify-center items-center md:flex-row md:space-x-5 md:space-y-0 ">
        <div className="mt-[50vh] iphone-xr:mt-[20vh] md:mt-[20vh] pixel-7:mt-[10vh] s-8+:mt-[30vh] ipad-air:mt-[1vh] surface-duo:mt-[30vh] z-fold:mt-[20vh] nest-hub:mt-[70vh] nest-hubmax:mt-[60vh] def-an:mt-[30vh] ip-se:mt-[50vh]">
